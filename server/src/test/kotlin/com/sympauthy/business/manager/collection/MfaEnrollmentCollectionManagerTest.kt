...
class MfaEnrollmentCollectionManagerTest {
    ...
    fun `listConfirmedEnrollments - Order by confirmation date, then by identifier`() = runTest {
        ...
        val result = mfaEnrollmentCollectionManager.listConfirmedEnrollments(userId, criteriaOf(), firstPage)
    ...
    fun `listConfirmedEnrollments - Return the page the parameters name`() = runTest {
        ...
        val result = mfaEnrollmentCollectionManager.listConfirmedEnrollments(
    ...
    private suspend fun criteriaOf(
        ...
        mfaEnrollmentCollectionManager.capabilities().criteriaOf(*filters, sort = sort)
}
