...
@Schema(description = "Information about an invitation.")
@Serdeable
data class AdminInvitationResource(
    ...
    @get:JsonInclude(JsonInclude.Include.NON_NULL)
    val note: String?,
    @get:Schema(description = "Who created this invitation.", allowableValues = ["admin", "client", "bootstrap"])
    ...
    @get:Schema(description = "Date and time the invitation was revoked.", nullable = true)
