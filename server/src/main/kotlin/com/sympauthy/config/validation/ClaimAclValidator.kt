...
class ClaimAclValidator {
    ...
    private fun validateConsentScope(
        ...
        val configuredScope = scopesById[scope]
        if (configuredScope is ConsentableUserScope) return
        ...
        val detailsId = if (configuredScope is DisabledScope && configuredScope.type == ScopeType.CONSENTABLE) {
