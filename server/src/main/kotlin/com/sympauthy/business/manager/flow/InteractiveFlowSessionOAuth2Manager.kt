...
open class InteractiveFlowSessionOAuth2Manager(
    ...
    open suspend fun startOAuth2Session(
        ...
        val session = sessionManager.newSession(FlowPurpose.OAUTH2_AUTHORIZE, flow, error)
     ...
     *
     * Throws an internal [BusinessException] if the [session]'s purpose is not [FlowPurpose.OAUTH2_AUTHORIZE]
